...
#define MIN_LEN_PREVIOUS_PATH 4
...
#define N_SAMPLES 20
#define DT 0.2
#define DURATION_PREDICTION 4           //seconds.

#define SPEED_LIMIT 21.5                // m/s
#define VELOCITY_INCREMENT_LIMIT 0.1   // m/s

// cost function weights
#define COLLISION_COST_WEIGHT 10000
#define AVG_ACCEL_COST_WEIGHT 10
#define AVG_JERK_COST_WEIGHT 10
